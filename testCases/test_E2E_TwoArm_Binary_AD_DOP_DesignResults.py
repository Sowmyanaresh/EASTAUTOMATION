...
class Test_EndtoEnd_TwoArm_Binary_DOP_Ad_Results:

    baseURL = ReadConfig.getApplicationURL()
    username = ReadConfig.getUserName()
    password = ReadConfig.getPassword()
    wrapperTestData = ReadConfig.getwrapperTD("E2E_TwoArm_ADResults_DOP")
    ...
    def test_EndtoEnd_TwoArm_Binary_DOP_Ad_Results(self,testcase,setup,extra,request):
