...
class Test_EndtoEnd_OneArmCont_MOPD_Ad_Results:

    baseURL = ReadConfig.getApplicationURL()
    username = ReadConfig.getUserName()
    password = ReadConfig.getPassword()
    wrapperTestData = ReadConfig.getwrapperTD("E2E_OneArm_ADResults_MOPD")
    ...
    def test_EndtoEnd_OneArmCont_MOPD_Ad_Results(self,testcase,setup,extra,request):
            ...
            for row_index, row_data in datafile.iterrows():
                try:                    
                    ...
                    try:
                        ...
                        self.DesignHelper.process_input_row_MOPD(row_data)    
