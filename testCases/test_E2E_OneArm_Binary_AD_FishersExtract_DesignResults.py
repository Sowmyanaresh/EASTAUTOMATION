...
class Test_EndtoEnd_TwoArmBinary_FisherEx_Ad_Results:

    baseURL = ReadConfig.getApplicationURL()
    username = ReadConfig.getUserName()
    password = ReadConfig.getPassword()
    wrapperTestData = ReadConfig.getwrapperTD("E2E_TwoArm_ADResults_FishersExtract")
    ...
    def test_EndtoEnd_TwoArmBinary_FisherEx_Ad_Results(self,testcase,setup,extra,request):
        LogGen.loggen().info(f"TwoArm-Binary-FisherEx- {testcase} started")
            ...
            for row_index, row_data in datafile.iterrows():
                try:                    
                    ...
                    try:
                        ...
                        self.DesignHelper.process_input_row_Fishers_Extract(row_data)    
