...
class Test_EndtoEnd_OneArmBinary_SP_Ad_Results:

    baseURL = ReadConfig.getApplicationURL()
    username = ReadConfig.getUserName()
    password = ReadConfig.getPassword()
    wrapperTestData = ReadConfig.getwrapperTD("E2E_OneArm_ADResults_SingleProp")
    ...
    def test_EndtoEnd_OneArmBinary_SP_Ad_Results(self,testcase,setup,extra,request):
        LogGen.loggen().info(f"One-Arm-Continuous -SP- {testcase} started")
            ...
            for row_index, row_data in datafile.iterrows():
                try:                    
                    ...
                    try:
                        ...
                        self.DesignHelper.process_input_row_SingleProportion(row_data)    
