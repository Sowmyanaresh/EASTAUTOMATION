...
class Test_EndtoEnd_OneArmBinary_SS_Ad_Results:

    baseURL = ReadConfig.getApplicationURL()
    username = ReadConfig.getUserName()
    password = ReadConfig.getPassword()
    wrapperTestData = ReadConfig.getwrapperTD("E2E_OneArm_ADResults_SimonTwoStage")
    ...
    def test_EndtoEnd_OneArmBinary_SS_Ad_Results(self,testcase,setup,extra,request):
        LogGen.loggen().info(f"One-Arm-Continuous -SS- {testcase} started")
            ...
            for row_index, row_data in datafile.iterrows():
                try:                    
                    ...
                    try:
                        ...
                        self.DesignHelper.process_input_row_Simon_Two_Stage(row_data)    
        ...
        self.driver.quit()
        LogGen.loggen().info(f"O{testcase} completed")
